...
groq_api_key = "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"
...
async def on_chat_start():
    ...
    await cl.Avatar(
        name="BidBooster",
        path="https://static.vecteezy.com/system/resources/previews/025/213/708/original/ai-robot-chatbot-png.png",
    ).send()

    await cl.Avatar(
        name="You",
        path="https://cdn1.iconfinder.com/data/icons/user-pictures/100/male3-512.png",
    ).send()
